			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="cart_container">
						<div class="cart_title">Mis métodos de pago</div>
								...
								<li class="cart_item clearfix">
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Nombre del Titular</div>
											<div class="cart_item_text">{{$tar->nombre_tarjeta}}</div>
										</div>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Fecha de expiración</div>
											<div class="cart_item_text">{{$tar->fecha_expiracion}}</div>
										</div>
									</div>
								</li>
								@endforeach
